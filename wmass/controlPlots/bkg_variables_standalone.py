...
bkg_variables_standalone = {
    ...
    'variables' :{
        ...
        'Muon_pfRelIso04_all': ('muon pfRelIso04', 400, 0., 0.5, 'Muon_pfRelIso04_all[Idx_mu1]'),
        'MET_pt':  ('MET P_{T}',  120, 0, 120, 'MET_pt'),
        'PV_npvsGood' :  ('Number of good primary vertices',  100, 0, 100, 'PV_npvsGood'),
        'Muon_pfRelIso04_all_corrected_pt': ('muon pfAbsIso04',800, 0., 40,'Muon_pfRelIso04_all[Idx_mu1]*Muon_corrected_pt[Idx_mu1]'),
    },
    'D2variables':{
        'Muon_pfRelIso04_all_corrected_MET_nom_mt':   ('M_{T} (Rochester corr./smear MET) VS muon pfRelIso04', 400, 0., 0.5,120, 0, 120, "Muon_pfRelIso04_all[Idx_mu1]","Muon_corrected_MET_nom_mt[Idx_mu1]", "Muon_eta[Idx_mu1]"),        
        'Muon_pfRelIso04_all_corrected_pt_corrected_MET_nom_mt':   ('M_{T} (Rochester corr./smear MET) VS muon pfAbsIso04', 800, 0., 40,120, 0, 120, "Muon_pfRelIso04_all[Idx_mu1]*Muon_corrected_pt[Idx_mu1]","Muon_corrected_MET_nom_mt[Idx_mu1]", "Muon_eta[Idx_mu1]"),         
        'Muon_pfRelIso04_all_MET_pt':   ('MET p_{T} VS muon pfRelIso04', 400, 0., 0.5,120, 0, 120, "Muon_pfRelIso04_all[Idx_mu1]","MET_pt", "Muon_eta[Idx_mu1]"),        
        'Muon_pfRelIso04_all_corrected_pt_MET_pt':   ('MET p_{T} VS muon pfIso04', 800, 0., 40, 120, 0, 120,"Muon_pfRelIso04_all[Idx_mu1]*Muon_corrected_pt[Idx_mu1]","MET_pt", "Muon_eta[Idx_mu1]"),
    }
}

...
//
static
TrackAssociatorByPositionImpl::Method parseMethodName(const std::string& meth) {
  if (meth=="chi2"){ return TrackAssociatorByPositionImpl::Method::chi2; }
  else if (meth=="dist"){return TrackAssociatorByPositionImpl::Method::dist;}
  else if (meth=="momdr"){return TrackAssociatorByPositionImpl::Method::momdr;}
  else if (meth=="posdr"){return TrackAssociatorByPositionImpl::Method::posdr;}
  else{
...
void
TrackAssociatorByPositionProducer::produce(edm::StreamID, edm::Event& iEvent, const edm::EventSetup& iSetup) const
{
   using namespace edm;

...
config.General.requestName = 'NNClustSeedInputSimHit_4LayClustPt_4M_cutPt_intProtection'
...
config.Data.outputDatasetTag = 'NNClustSeedInputSimHit_4LayClustPt_4M_cutPt_intProtection'

...
process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(20) ) #-1 = tutti
...
process.demo = cms.EDProducer('TkSeedGeneratorNN' ,#demo = nome libero
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("histo_test_20.root"),
      closeFileFast = cms.untracked.bool(True)
  )


process.p = cms.Path(process.remerge*process.demo
